...
Pool.prototype._reset = function () {
    ...
    this.maxS = this.peers.reduce( function( a, b ) {
        return a.weight > b.weight ? a : b;
    }).weight;

    this.gcdS = this.peers.reduce( function( prev, cur ) {
        return gcd( prev.weight, cur.weight );
    }).weight;
...
Pool.prototype.get = function (predicate) {
    var i = this.peers.map( function( peer ) { return peer.value }).findIndex( predicate );
